...
Este diagrama representa los dos tipos de elementos, nodos y conexiones, as\'i como la distribucio\'on de componentes del sistema 
de informacio\'on con respecto a la particio\'on fisica del sistema.\\
\begin{figure}[H]
	\begin{center}
...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Rastreo  
  \end{itemize}
  \item \textbf{Artefacto:} Los moodelos en 3D de los \'organos del sistema digestivo.
\end{itemize}
...
de producción de productos multimedia y integrar las etapas de producción multimedia con el ciclo de vida del desarrollo de software.\cite{al2019multimedia}
...
Un flujo de acciones se refiere al orden en que se muestran los marcos de los productos a los usuarios, En productos estaticos, no hay flujo de acciones, ya que los usuarios leen 
ven un marco.\\ 
