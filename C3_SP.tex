...
\begin{longtable}{cccll}
  \multicolumn{3}{c}{\textbf{Componentes de computadora de escritorio armada.}}                                                                                                                                        &  &  \\
  \endfirsthead
  %
  \endhead
  %
  \textbf{Producto}                  & \textbf{Modelo}                                                                                                                                               & \textbf{Precio} &  &  \\
  Tarjeta Madre                      & {\color[HTML]{15C} {\ul ASUS Prime B350-Plus AMD Ryzen AM4 DDR4 HDMI DVI VGA M.2 USB 3.1 ATX B350 Motherboard}}                                               & \$ 1,909.08     &  &  \\
  Tarjeta de Red Inalámbrica         & {\color[HTML]{15C} {\ul TP-LINK TL-WN881ND Adaptador de red inalámbrica PCI Express N300, 2.4 GHz, 300 Mbps}}                                                 & \$ 271.00       &  &  \\
  Tarjeta Ampliación Puertos USB 3.0 & {\color[HTML]{15C} {\ul Tarjeta Adaptador PCI Express PCI-E USB 3.0 con UASP de 4 Puertos}}                                                                   & \$ 300.00       &  &  \\
  Cable alimentación Molex a SATA    & {\color[HTML]{15C} {\ul StarTech  Adaptador Cable Alimentación Corriente SATA Estándar con Ángulo a la Izquierda 15 Pines a Molex 4 Pines, Macho LP4, 15 cm}} & \$ 118.00       &  &  \\
  Cable divisor PWM 2-1              & {\color[HTML]{15C} {\ul SilverStone All Black Sleeved 1-to-2 Sleeved PWM Fan Splitter Cable (CPF01)}}                                                         & \$ 76.99        &  &  \\
  Ventiladores para el gabinete      & {\color[HTML]{15C} {\ul Thermaltake RIING 120mm Red LEDCL-F047-PL12RE-A}}                                                                                     & \$ 565.11       &  &  \\
  Enfriador de la CPU                & {\color[HTML]{15C} {\ul MSI CPU Cooler, Silver/Black (Core Frozr L)}}                                                                                         & \$ 954.44       &  &  \\
  Procesador                         & {\color[HTML]{15C} {\ul Procesador AMD Ryzen 5 1600, S-AM4, 3.20GHz, Six-Core}}                                                                               & \$ 4,998.00     &  &  \\
  Memoria RAM                        & {\color[HTML]{15C} {\ul GeIL 16GB (2 x 8GB) 288-Pin DDR4 RGB GALTS416GB3000C16ADC}}                                                                           & \$ 3,039.22     &  &  \\
  Tarjeta de Video                   & {\color[HTML]{15C} {\ul ASUS STRIX-RX480-O8G-GAMING Graphic Card AMD Radeon RX 480 8GB OC Edition, Polaris, DisplayPort 1.4 HDMI 2.0}}                        & \$4,564.78      &  &  \\
  Disco duro                         & {\color[HTML]{15C} {\ul Toshiba DT01ACA200 Disco Duro de Escritorio 2 TB, SATA III 6GB-s, 7200RPM, Memoria Caché 64MB, 3.5"}}                                 & \$ 1,328.20     &  &  \\
  Disco estado sólido                & {\color[HTML]{15C} {\ul ADATA SU800SS-128GT-C Unidad SSD, 128GB}}                                                                                             & \$ 1,049.80     &  &  \\
  Cables SATA                        & {\color[HTML]{15C} {\ul UGREEN Cable SATA III de Datos 6 Gbps 3 Unidades}}                                                                                    & \$105.99        &  &  \\
  Disco Estado Sólido NVMe           & {\color[HTML]{15C} {\ul Silicon Power 256GB - NVMe PCIe Gen3 x4 M.2 2280 (SP256GBP34A80M28)}}                                                                 & \$ 960.99       &  &  \\
  Monitor                            & {\color[HTML]{15C} {\ul AOC G2460VQ6 24" Free Sync Gaming Anti Blue Light LED Monitor Full HD 75hz 1ms Speakers VGA/HDMI/DP}}                                 & \$ 2,676.32     &  &  \\
  Cable Monitor DP                   & {\color[HTML]{15C} {\ul Ugreen Cable de DisplayPort 2 Metro Macho a Macho Soporte Resolución 4K x 2K y Full 1080P HD}}                                        & \$ 145.00       &  &  \\
  Teclado                            & {\color[HTML]{15C} {\ul Teclado Gamer Logitech G213 Prodigy LED RGB, Alámbrico, Negro, Inglés}}                                                               & \$ 828.00       &  &  \\
  Mouse                              & {\color[HTML]{15C} {\ul Logitech 910-004616 Mouse G502 Proteus Spectrum, 12000DPi, 11 buttons}}                                                               & \$ 899.00       &  &  \\
  Mousepad                           & {\color[HTML]{15C} {\ul MOUSE PAD EAGLE WARRIOR GAMER XL FIGHTER GAMER AMOUSEPAD8035EGW}}                                                                     & \$ 264.71       &  &  \\
  \multicolumn{1}{l}{}               & \textbf{Total:}                                                                                                                                               & \$ 25,054.63    &  & 
