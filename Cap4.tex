...
\begin{itemize}
    ...
    \begin{figure}[H]
       	\begin{center}
       		...
       		\captionof{figure}{\label{fig:im414}odelo de manos, mostrando cómo se alza el dedo índice cuando el usuario lo hace a través de los sensores y botones del control.}
       	\end{center} 
    \end{figure}
    \begin{figure}[H]
        \begin{center}
