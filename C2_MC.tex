...
cuadrantes o regiones, utilizando cuatro líneas trazadas imaginariamente, dos verticales y dos horizontales.\cite{web12} %Agregar imagen de las secciones
\begin{figure}[H]
	\begin{center}
 		\includegraphics[width = .3\textwidth]{source/images/image56.png}
 		\captionof{figure}{\label{fig:im24}Cavidades del cuerpo humano.}
	\end{center} 
\end{figure} %Agregar cuadrantes de Cavidad abdominal
