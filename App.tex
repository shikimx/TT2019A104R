...
\begin{figure}[H]
	\begin{center}
         ...
         torácica anterior, el pericardio y el epicardio, se ha dividido la tráquea [ 45 ]}
	\end{center} 
\end{figure}
\begin{enumerate}
...
el contenido de su estómago no pueda regresar al esófago o a la garganta. [ 46 ]\\
	\begin{center}
 		...
 		\captionof{figure}{\label{fig:a4}Diafragma y pared abdominal (vista anterior)  [ 47 ] }
	\end{center} 
\end{figure}
\begin{enumerate}
...
importante de la carne. [ 48 ]\\
\begin{figure}[H]
	\begin{center}
 		\includegraphics[width = 1\textwidth]{v2/images/image2.png}
 		\captionof{figure}{\label{fig:a5}Vista anterior del estómago y sus relaciones [ 49 ]}
	\end{center} 
\end{figure}
\begin{enumerate}
    \item Esófago
...
\begin{figure}[H]
	\begin{center}
 		\includegraphics[width = 1\textwidth]{v2/images/image79.png}
...
\begin{figure}[H]
	\begin{center}
 		...
 		\captionof{figure}{\label{fig:a7}Vista anterior del hígado\footnote{ Debido a que el hígado está unido al diafragma en la gran zona desprovista de peritoneo se mueve con la respiración y esto ayuda con la respiración intrahepática. El ligamento redondo es un resto de la vena umbilical de circulacion fetal.}  [ 53 ]}
	\end{center} 
\end{figure}
\begin{enumerate}
    \item Lóbulo derecho
...
\begin{figure}[H]
	\begin{center}
 		...
 		\captionof{figure}{\label{fig:a8} Páncreas y duodeno, bazo, vesícula biliar e hígado (vista anterior). [ 56 ]}
	\end{center} 
\end{figure}
\begin{enumerate}
    \item Vesícula biliar
...
\begin{figure}[H]
	\begin{center}
 		\includegraphics[width = 1\textwidth]{v2/images/image7.png}
...
\begin{figure}[H]
	\begin{center}
 		...
 		\captionof{figure}{\label{fig:a10}Tracto gastrointestinal  [ 58 ]}
	\end{center} 
\end{figure}
\begin{enumerate}
