...
\begin{figure}[H]
	\begin{center}
 		...
 		\captionof{figure}{\label{fig:j1}Disposición de los consumidores a nivel mundial para usar la realidad virtual y aumentada si esta se encuentra disponible en los próximos 2 años(2020 -2021).}
	\end{center} 
\end{figure}
\begin{figure}[H]
	\begin{center}
 		\includegraphics[width = 0.7\textwidth]{v3/images/chart1.png}
 		\captionof{figure}{\label{fig:j2}Disposición de los consumidores a nivel mundial para no usar la realidad virtual y aumentada si esta se encuentra disponible en los próximos 2 años (2020 -2021).}
	\end{center} 
\end{figure}
